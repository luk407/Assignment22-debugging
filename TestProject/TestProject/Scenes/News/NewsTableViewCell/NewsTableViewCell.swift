...
final class NewsTableViewCell: UITableViewCell { //switched to UITableViewCell
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            mainStackView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 10), // changed last 3 to correct anchors
    ...
    // MARK: - Configure
    func configure(with news: News) { //removed private keyword
